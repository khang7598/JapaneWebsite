...
namespace JapaneWebsite.Areas.Admin.Controllers
{
    public class QuestionsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IdQuestion,IdTest,Name,Option1,Option2,Option3,Option4,Answer")] Question question)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IdQuestion,IdTest,Name,Option1,Option2,Option3,Option4,Answer")] Question question)
        {
            if (ModelState.IsValid)
            {
